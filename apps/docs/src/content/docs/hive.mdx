...
just has no way to reach it. The full contract for that namespace — pairing, routing over iroh,
one origin per dashboard — is the fleet documentation's job (`docs/fleet.md`), not this page's.
